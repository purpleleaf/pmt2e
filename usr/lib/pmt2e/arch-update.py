...
def show_menu():
    ...
    if not os.path.isfile(pmt2e_dir + "/menu-update.sh"):
        subprocess.call(["cp /usr/lib/pmt2e/menu-update.sh "+ pmt2e_dir + "/menu-update.sh"], shell=True)
    subprocess.call([pmt2e_dir + '/menu-update.sh'], shell=True)
